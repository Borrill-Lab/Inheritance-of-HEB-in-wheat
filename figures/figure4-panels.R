# This script produces panels for figure 4 from intermediate data tables created during the analysis
library(tidyverse)
library(dplyr)
library(ggplot2)
library(svglite)
...
ggplot(fig4_panelA,aes(y = forcats::fct_rev(Cross),fill=Subgenome)) + geom_bar(position = position_dodge2(reverse = T),color='black') +
  ...
  annotate("text",label = paste0(dim(fig4_panelA[fig4_panelA$Cross=='PxC' & fig4_panelA$Subgenome=='A',])[1]),x=3800,y=2.3,size = 12) +
  annotate("text",label = paste0(dim(fig4_panelA[fig4_panelA$Cross=='PxC' & fig4_panelA$Subgenome=='B',])[1]),x=4400,y=2.0,size = 12) +
  annotate("text",label = paste0(dim(fig4_panelA[fig4_panelA$Cross=='PxC' & fig4_panelA$Subgenome=='D',])[1]),x=1200,y=1.7,size = 12) +
  annotate("text",label = paste0(dim(fig4_panelA[fig4_panelA$Cross=='PxW' & fig4_panelA$Subgenome=='A',])[1]),x=3500,y=1.3,size = 12) +
  annotate("text",label = paste0(dim(fig4_panelA[fig4_panelA$Cross=='PxW' & fig4_panelA$Subgenome=='B',])[1]),x=2400,y=1.0,size = 12) +
  annotate("text",label = paste0(dim(fig4_panelA[fig4_panelA$Cross=='PxW' & fig4_panelA$Subgenome=='D',])[1]),x=1000,y=0.7,size = 12)
...
upset(fig4_panelBtranss,c('gene_D','gene_B','gene_A','snp_D','snp_B','snp_A'),sort_sets=F, set_sizes = F,
      sort_intersections=F,
      intersections=list(c('snp_A','gene_A'),c('snp_B','gene_B'),c('snp_D','gene_D')),
      stripes = c(alpha("#FF950E",0.9),alpha("#4B1F6F",0.9),alpha("#579D1C",0.9)),
      matrix=intersection_matrix(geom = geom_point(size=7),segment = geom_segment(lwd=4)),
...
#plot top of the graph separately to get the full figure later
upset(fig4_panelBtranss,c('gene_D','gene_B','gene_A','snp_D','snp_B','snp_A'),sort_sets=F, set_sizes = F,
      sort_intersections=F,
      intersections=list(c('snp_A','gene_A'),c('snp_B','gene_B'),c('snp_D','gene_D')),
      stripes = c(alpha("#FF950E",0.9),alpha("#4B1F6F",0.9),alpha("#579D1C",0.9)),
...
upset(fig4_panelBtransd,c('gene_D','gene_B','gene_A','snp_D','snp_B','snp_A'),sort_sets=F, set_sizes = F,
      sort_intersections=F,
...
upset(fig4_panelCcis,c('gene_D','gene_B','gene_A','snp_D','snp_B','snp_A'),sort_sets=F, set_sizes = F,
      sort_intersections=F,
      intersections=list(c('snp_A','gene_A'),c('snp_B','gene_B'),c('snp_D','gene_D')),
      stripes = c(alpha("#FF950E",0.9),alpha("#4B1F6F",0.9),alpha("#579D1C",0.9)),
      matrix=intersection_matrix(geom = geom_point(size=7),segment = geom_segment(lwd=4)),
...
upset(fig4_panelCtranss,c('gene_D','gene_B','gene_A','snp_D','snp_B','snp_A'),sort_sets=F, set_sizes = F,
      sort_intersections=F,
      intersections=list(c('snp_A','gene_A'),c('snp_B','gene_B'),c('snp_D','gene_D')),
      stripes = c(alpha("#FF950E",0.9),alpha("#4B1F6F",0.9),alpha("#579D1C",0.9)),
      matrix=intersection_matrix(geom = geom_point(size=7),segment = geom_segment(lwd=4)),
...
upset(fig4_panelCtransd,c('gene_D','gene_B','gene_A','snp_D','snp_B','snp_A'),sort_sets=F, set_sizes = F,
      sort_intersections=F,
      intersections=list(c('snp_A','gene_A'),c('snp_A','gene_B'),c('snp_A','gene_D'),
                         c('snp_B','gene_A'),c('snp_B','gene_B'),c('snp_B','gene_D'),
                         c('snp_D','gene_A'),c('snp_D','gene_B'),c('snp_D','gene_D')),
