...
my $input_dir = "/jic/scratch/groups/Philippa-Borrill/Marek/eQTL-RNAseq-data-apr23/PCmap/picardout/";
...
my $list_of_gt = "/jic/scratch/groups/Philippa-Borrill/Marek/eQTL-RNAseq-data-apr23/PCmap/picardout/listofsamples";
...
#SBATCH -c 4
#SBATCH --mem=100000
#SBATCH -o /jic/scratch/groups/Philippa-Borrill/Marek/eQTL-RNAseq-data-apr23/PCmap/picardout/gatkout/%x.%N.%j.out
#SBATCH -e /jic/scratch/groups/Philippa-Borrill/Marek/eQTL-RNAseq-data-apr23/PCmap/picardout/gatkout/%x.%N.%j.err
SLURM
