...
#
# Aim of script is to run trimmomatic on RNA-seq data

#### paths and references:
my $read_path_triticum = "/jic/scratch/groups/Philippa-Borrill/Arun/f6_lines/fastq/";
my $output_dir = "/jic/scratch/groups/Philippa-Borrill/Arun/f6_lines/mapping/fastq_trim/";
...
my $input_list_dir = "/jic/scratch/groups/Philippa-Borrill/Arun/f6_lines/fastq/";
my $input_for_trim = "/jic/scratch/groups/Philippa-Borrill/Arun/f6_lines/fastq/input_for_mapping.txt";
...
#SBATCH --mem=120000
#SBATCH -J trim
#SBATCH -o /jic/scratch/groups/Philippa-Borrill/Arun/f6_lines/mapping/fastq_trim/slurm_output/trimsep%x.%N.%j.out
#SBATCH -e /jic/scratch/groups/Philippa-Borrill/Arun/f6_lines/mapping/fastq_trim/slurm_output/trimsep%x.%N.%j.err
SLURM
