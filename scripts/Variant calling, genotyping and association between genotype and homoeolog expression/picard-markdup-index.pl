...
my $read_path_triticum = "/jic/scratch/groups/Philippa-Borrill/Marek/mg_mapping/hisat2/";
my $output_dir = "/jic/scratch/groups/Philippa-Borrill/Marek/mg_mapping/picardout";
my $input_list_dir = "/jic/scratch/groups/Philippa-Borrill/Marek/mg_mapping/hisat2/";
my $input_for_picard = "/jic/scratch/groups/Philippa-Borrill/Marek/mg_mapping/hisat2/picard_input_file.txt";
...
#SBATCH -o /jic/scratch/groups/Philippa-Borrill/Marek/mg_mapping/picardout/slurm/picardslurm-%j.out
#SBATCH -e /jic/scratch/groups/Philippa-Borrill/Marek/mg_mapping/picardout/slurm/picardslurm-%j.err
SLURM
