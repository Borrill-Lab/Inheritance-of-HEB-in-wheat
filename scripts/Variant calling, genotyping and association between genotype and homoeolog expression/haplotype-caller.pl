...
my $input_dir = "/jic/scratch/groups/Philippa-Borrill/Marek/mg_mapping/picardout/";
...
my $list_of_gt = "/jic/scratch/groups/Philippa-Borrill/Marek/mg_mapping/picardout/listofsamples";
...
#SBATCH -c 4
#SBATCH --mem=100000
#SBATCH -o /jic/scratch/groups/Philippa-Borrill/Marek/mg_mapping/gatkout/slurm/gatk%x.%N.%j.out
#SBATCH -e /jic/scratch/groups/Philippa-Borrill/Marek/mg_mapping/gatkout/slurm/gatk%x.%N.%j.err
SLURM
